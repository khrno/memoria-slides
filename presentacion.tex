...
\usetheme[titlepagelogo=images/logo-utfsm.pdf,% Logo for the first page
						language=spanish,
						color=red,
...
% Configurations for no use a main language (english or italian)
\setrellabel{Profesores Guía}
\setcandidatelabel{Memorista}
\setassistentsupervisorlabel{Profesor Coreferente}
\setsubject{Memoria}
\usepackage[beamer,customcolors]{hf-tikz}
\hfsetfillcolor{alerted text.fg!10}
\hfsetbordercolor{alerted text.fg}

\author{Pablo Ortega Mesa}
\rel{Marcelo Mendoza}
\secondsupervisor{José Luis Martí}
\title{\textsc{Distribución de Tópicos Emergentes \\en Conceptos Formales}}
\ateneo{Universidad Técnica Federico Santa María}
\date{\today}
