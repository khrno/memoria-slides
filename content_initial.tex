...
\input{partials/9-docs-frame}
\input{partials/25-docs-frame}
\input{partials/infinite-docs-frame}
...
\input{partials/fca-example-frames}
...
\begin{tframe}{Marco Teórico - \emph{D3.js}}
	\includegraphics<1>[width=1\textwidth]{images/D3.js-Logo.png}
	\begin{itemize}
